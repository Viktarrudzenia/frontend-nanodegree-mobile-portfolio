...
function generator(adj, noun) {
    ...
    const name =
        "The " + adjectives[randomAdjective].capitalize() + " " + nouns[randomNoun].capitalize();
    return name;
}
...
const selectRandomMeat = function() {
    const randomMeat =
        pizzaIngredients.meats[Math.floor(Math.random() * pizzaIngredients.meats.length)];
    return randomMeat;
};

const selectRandomNonMeat = function() {
    const randomNonMeat =
        pizzaIngredients.nonMeats[Math.floor(Math.random() * pizzaIngredients.nonMeats.length)];
    return randomNonMeat;
};

const selectRandomCheese = function() {
    const randomCheese =
        pizzaIngredients.cheeses[Math.floor(Math.random() * pizzaIngredients.cheeses.length)];
    return randomCheese;
};

const selectRandomSauce = function() {
    const randomSauce =
        pizzaIngredients.sauces[Math.floor(Math.random() * pizzaIngredients.sauces.length)];
    return randomSauce;
};

const selectRandomCrust = function() {
    const randomCrust =
        pizzaIngredients.crusts[Math.floor(Math.random() * pizzaIngredients.crusts.length)];
    return randomCrust;
};
...
const resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        ...
        for (let i = 0; i < randomPizzaContainer.length; i++) {
            let newwidth = sizeSwitcher(size) * 100 + "%";
